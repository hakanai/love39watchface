...
public class DozenalTimeTest {
    ...
    public void testMidnightAtStartOfYear() {
        ...
        time.setTo(GregorianTimeTestUtils.buildTime(2015, 3, 1, 0, 0));
    ...
    public void testMidnightAtEndOfYear() {
        DozenalTime time = new DozenalTime();
        time.setTo(GregorianTimeTestUtils.buildTime(2015, 2, 28, 0, 0));
    ...
    public void testMidnightAtEndOfLeapYear() {
        DozenalTime time = new DozenalTime();
        time.setTo(GregorianTimeTestUtils.buildTime(2016, 2, 29, 0, 0));
        assertThat(time.getYear(), is(2015));
        assertThat(time.getMonth(), is(13));
    ...
    public void testMidday() {
        DozenalTime time = new DozenalTime();
        time.setTo(GregorianTimeTestUtils.buildTime(2015, 3, 1, 12, 0));
    ...
    public void testHalfMorning() {
        DozenalTime time = new DozenalTime();
        time.setTo(GregorianTimeTestUtils.buildTime(2015, 3, 1, 6, 0));
